...
interface ISwapperEngine {
    ...
    /// @param deadline The absolute timestamp after which the swap reverts
    ...
    /// @param poolInfo The pool information to use for the quote
    /// @param amountOut The desired amount of `base` to receive.
    /// @param base The asset to receive (output)
    /// @param quote The asset to spend (input)
    /// @return amountIn The amount of `quote` required to receive `amountOut` of `base`.
