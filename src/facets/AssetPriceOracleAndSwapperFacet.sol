...
import {IAssetPriceOracleAndSwapper, AssetPair} from "../interfaces/IAssetPriceOracleAndSwapper.sol";
...
contract AssetPriceOracleAndSwapperFacet is AssetPriceOracleAndSwapper, IERC165 {
    ...
    function supportsInterface(bytes4 interfaceId) external pure returns (bool) {
        return interfaceId == type(IAssetPriceOracleAndSwapper).interfaceId || interfaceId == type(IERC165).interfaceId;
    }
}
