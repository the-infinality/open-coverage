...
export function ContractsPage() {
    ...
    useEffect(() => {
        ...
        const validChainIds = availableChainIds.filter((id) => selectedChainIds.has(id))
    ...
    useEffect(() => {
        ...
        const validTypes = availableContractTypes.filter((type) => selectedContractTypes.has(type))
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between gap-2.5 flex-wrap">
                <div className="min-w-[300px]">
                    ...
                    <p className="text-muted-foreground">View and manage your saved contracts</p>
                </div>
                            ...
                            <div className="flex items-start gap-3 rounded-lg border p-3">
                                ...
                                <div className="flex-1 space-y-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        If enabled, contracts with matching addresses and chain IDs
                                        will be updated with data from the imported file. Otherwise,
            ...
            <Dialog open={isExportDialogOpen} onOpenChange={setIsExportDialogOpen}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Select the contracts you want to export. All contracts are selected by
                            default.
                        </DialogDescription>
                    </DialogHeader>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    {selectedContractIds.size} of {filteredContracts.length}{" "}
                                    selected
                                </span>
                            </div>
                        </div>
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleExport} disabled={selectedContractIds.size === 0}>
                ...
                <Card>
                    <CardContent className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="mb-4 text-center text-sm text-muted-foreground">
                            Add your first contract to start interacting with the Open Coverage
                            system.
                        </p>
                        <Button asChild>
