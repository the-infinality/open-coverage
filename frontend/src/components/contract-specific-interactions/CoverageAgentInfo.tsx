...
import { useAvailableCoverageProviders, getSelectedProvider } from "@/hooks/use-chain-filtered-contracts"
...
export function CoverageAgentInfo({ contract }: CoverageAgentInfoProps) {
  ...
  const { availableProviders } = useAvailableCoverageProviders(contract.chainId, registeredProviderIds)
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
          ...
          <Button
            ...
            disabled={!selectedProvider || isPending || isConfirming || availableProviders.length === 0}
          >
